tinymce.PluginManager.add("image", function(e) {
    ...
    function i(r) {
        function i() {
            var e, t, n, r;
            e = d.find("#width")[0], t = d.find("#height")[0], e && t && (n = e.value(), r = t.value(), d.find("#constrain")[0].checked() && m && p && n && r && (m != n ? (r = Math.round(n / m * r), isNaN(r) || t.value(r)) : (n = Math.round(r / p * n), isNaN(n) || e.value(n))), m = n, p = r)
        }
        ...
        function s(n) {
            ...
            g && g.value(e.convertURL(this.value(), "src")), tinymce.each(a, function(e, t) {
                ...
                e.width && e.height && x && (m = e.width, p = e.height, d.find("#width").value(m), d.find("#height").value(p))
            }))
        }
        ...
        f = e.selection.getNode(), h = b.getParent(f, "figure.image"), h && (f = b.select("img", h)[0]), f && ("IMG" != f.nodeName || f.getAttribute("data-mce-object") || f.getAttribute("data-mce-placeholder")) && (f = null), f && (m = b.getAttrib(f, "width"), p = b.getAttrib(f, "height"), y = {
